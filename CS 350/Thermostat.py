...
class TemperatureMachine(StateMachine):
    ...
    def on_enter_heat(self):
        ...
        ##  Updates the lights on the thermostat.
        self.updateLights()
    ...
    def on_exit_heat(self):
        ...
        ## Changes the state of the indicator light when exiting the heat state.
        redLight.off()
    ...
    def on_exit_cool(self):
        ...
        ## Changes the state of the indicator light when exiting the cool state.
        blueLight.off()
    ...
    def on_enter_off(self):
        ...
        ## Changes the state of any indicator lights when entering the off state.
        redLight.off()
        blueLight.off()
    ...
    def processTempStateButton(self):
        ...
        ## Changes the state of the thermostat.
        self.cycle()
    ...
    def processTempIncButton(self):
        ...
        ## Updates the setPoint of the thermostat and the status lights within the circuit.
        self.setPoint += 1
        self.updateLights()
    ...
    def updateLights(self):
        ...
        ## Updates the status lights in our thermostat circuit. Keep in mind the
    ...
    def run(self):
        ...
        ## Starts console display and input menu
        keyboardThread = Thread(target=self.keyboardListener)
    ...
    def setupSerialOutput(self):
        ...
        output = f"{self.current_state.id}," \
                 f"{self.getFahrenheit():0.1f}," \
                 f"{self.setPoint}"
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if((counter % 30) == 0):
                ##
                ## Sends our current state information to the TemperatureServer
    ...
    ## Function for handling the keyboard input due to malfunctioning buttons
    def keyboardListener(self):
        while not self.endDisplay:

            current_time = datetime.now()

            ## Provides display to show user the current information and show inout options
            print("\n==============================")
            print(current_time.strftime("%m/%d %H:%M:%S"))
            print(f"State: {self.current_state.id}")
            print(f"Temperature: {self.getFahrenheit():0.1f}F")
            print(f"Set Point: {self.setPoint} F")
            print("==============================")
            print("Commands:")
            print("s = cycle state")
            print("+ = increase set point")
            print("- = decrease set point")
            print("q = quit")

            ## Takes user input
            cmd = input("Command: ")

            ## Determines which path to take given user input
            ## Whether that is the current state, increase, decrease, or quit display
            if cmd == "s":
                self.processTempStateButton()

            elif cmd == "+":
                self.processTempIncButton()

            elif cmd == "-":
                self.processTempDecButton()
...
##
## Assigns a function to be triggered when the button is pushed to
