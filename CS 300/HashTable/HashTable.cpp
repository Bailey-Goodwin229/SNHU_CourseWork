...
void HashTable::PrintAll() {
    ...
    for (auto it = nodes.begin(); it != nodes.end(); ++it) {
        ...
        if (it->key != UINT_MAX) {
            ...
            cout << "Key " << it->key << ": " << it->bid.bidId << " | " << it->bid.title << " | " <<it->bid.amount << " | " << it->bid.fund << endl;
            // node is equal to next iter
            Node* node = it->next;
            // while node not equal to nullptr
            while (node != nullptr) {
                // output key, bidID, title, amount and fund
                cout << "Key " << it->key << ": " << node->bid.bidId << " | " << node->bid.title << " | " << node->bid.amount << " | " << node->bid.fund << endl;
