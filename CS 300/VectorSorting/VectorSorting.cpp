...
// Implements the quick sort logic over bid.title
...
//  Implemented the selection sort logic over bid.title
...
int main(int argc, char* argv[]) {
    ...
    while (choice != 9) {
        ...
        //Invokes the selection sort and report timing results
        case 3:
            ticks = clock(); // introduces clock function
            selectionSort(bids); // calls selection sort for bids
            ticks = clock() - ticks; // gives us ticks it takes
            cout << bids.size() << " bids sorted" << endl;
            cout << "time: " << ticks << " clock ticks" << endl; // prints ticks
            cout << "time: " << ticks * 1.0 / CLOCKS_PER_SEC << " seconds" << endl; // prints time
            break;

        // Invokes the quick sort and report timing results
        case 4:
            ticks = clock(); // introduces clock function
            quickSort(bids, 0, bids.size() - 1); // calls quick sort for bids
            cout << bids.size() << " bids sorted" << endl;
            ticks = clock() - ticks; // gives us ticks it takes
            cout << "time: " << ticks << " clock ticks" << endl; // prints ticks
            cout << "time: " << ticks * 1.0 / CLOCKS_PER_SEC << " seconds" << endl; // prints time
